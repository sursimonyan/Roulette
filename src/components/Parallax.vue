...
<template>
  <div class="absolute top-0 left-0 w-full h-[100vh]">
    <img
    ...
    >
    <div 
      class="absolute bottom-0 left-0 max-w-[500px] w-[30vw] z-10 overflow-hidden"
      :style="parallaxLady"
    >
      <img class="" src="@/assets/images/lady.png" alt="lady">
    </div>
  </div>
</template>
